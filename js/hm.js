...
const totalAveragePlaytimePerGame = players.reduce((averageTime, player) => {
  let averagePerPlayer = player.playtime / player.gamesPlayed;
  return averageTime += averagePerPlayer;
...
const names = books
  ...
  .toSorted((bookOne, bookTwo) => bookOne.localeCompare(bookTwo));
